...
?>
<section id="tasks-dash-category-<?php echo esc_attr( $category_slug ); ?>" class="tasks-dash-category" data-color="<?php echo esc_attr( $category_data['color'] ); ?>" data-category="<?php echo esc_attr( $category_slug ); ?>">
    <header>
